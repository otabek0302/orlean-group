      ...
      <section id="contact" className="py-10 lg:py-14">
        <div className="container px-4">
          <div className="bg-primary dark:bg-input/30 grid grid-cols-1 gap-4 overflow-hidden rounded-[24px] p-4 shadow-lg md:grid-cols-3">
            ...
            <div className="bg-primary dark:bg-input/30 col-span-2 rounded-[24px] flex flex-col justify-between px-4 py-8 lg:px-20 lg:py-32">
              <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <div>
                      ...
                      <Input 
                        ...
                        placeholder={t('pages.contact.form.placeholder.first-name')} 
                        className="border-primary/20 text-primary placeholder:text-primary/40 focus:ring-none h-11 rounded-xl bg-white focus:border-none focus:ring-offset-0 focus:outline-none lg:h-12" 
                      />
                    </div>
                    <div>
                      ...
                      <Input 
                        ...
                        onChange={handleChange}
                        placeholder={t('pages.contact.form.placeholder.last-name')} 
                        className="border-primary/20 text-primary placeholder:text-primary/40 focus:ring-none h-11 rounded-xl bg-white focus:border-none focus:ring-offset-0 focus:outline-none lg:h-12" 
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea 
                      ...
                      className="border-primary/20 text-primary placeholder:text-primary/40 focus:ring-none min-h-[100px] resize-none rounded-xl bg-white focus:border-none focus:ring-offset-0 focus:outline-none lg:min-h-[120px]" 
                    />
                  </div>
                  <Button 
                    type="submit" 
                    disabled={isSubmitting}
                    className="group bg-primary hover:border-primary/20 hover:bg-primary/90 h-11 w-full rounded-xl border-2 border-transparent font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed lg:h-12"
                  >
                    <span className="mr-2 text-sm lg:text-base">
                      {isSubmitting ? 'Отправка...' : t('pages.contact.form.send')}
                    </span>
                  </Button>
                </form>
              </div>
