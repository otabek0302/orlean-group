      ...
      <section id="services" className="py-8 lg:py-20">
        <div className="container px-4">
          ...
          <ul className="grid grid-cols-1 grid-rows-none gap-3 h-full md:grid-cols-12 md:grid-rows-3 lg:gap-4 xl:grid-rows-2">
            ...
            <GridItem area="md:[grid-area:2/1/3/7] xl:[grid-area:1/5/1/8]" image={<Image src={ProcessOptimization} alt="process-optimization" fill priority className="h-full w-full object-cover" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />} title={t('pages.home.services.grid.process-optimization.title')} description={t('pages.home.services.grid.process-optimization.description')} link="/products/payverify/payverify.html" />
