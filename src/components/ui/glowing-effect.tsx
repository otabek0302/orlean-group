        ...
        style={
          {
            ...
            '--gradient':
              variant === 'white'
                ...
                : `radial-gradient(circle, #023E7D 10%, #023E7D00 20%),
                radial-gradient(circle at 40% 40%, #023E7D 5%, #023E7D00 15%),
                radial-gradient(circle at 60% 60%, #023E7D 10%, #023E7D00 20%), 
                radial-gradient(circle at 40% 60%, #023E7D 10%, #023E7D00 20%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #023E7D 0%,
                  #023E7D calc(25% / var(--repeating-conic-gradient-times)),
                  #023E7D calc(50% / var(--repeating-conic-gradient-times)), 
                  #023E7D calc(75% / var(--repeating-conic-gradient-times)),
                  #023E7D calc(100% / var(--repeating-conic-gradient-times))
                )`,
